...
<body>
	<div class="container">
			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav me-auto mb-2 mb-lg-0">
						...
						<li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false"> Item </a>
		...
		<%
		// 세션에 로그인 정보가 담겨 있는지 확인
		LoginDTO loginDto = (LoginDTO) session.getAttribute("loginDto");
		//out.print("<h3>"+loginDto+"</h3>"); =>안담으면 null
		if(loginDto !=null){		
		%>
