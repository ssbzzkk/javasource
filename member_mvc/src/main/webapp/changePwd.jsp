...
<%@ include file="/include/header.jsp" %>
	...
	<form method="post" action = '<c:url value="/change.do"/>'>
		...
		<div class="form-floating">
			...
			<label for="floatingPassword1">기존비밀번호</label>
		</div>
		<div class="form-floating">
		...
		<div class="form-floating">
			<input type="password" class="form-control" id="floatingPassword3" placeholder="새비밀번호확인" name="confirm-password">
			<label for="floatingPassword3">새비밀번호확인</label>
		</div>
