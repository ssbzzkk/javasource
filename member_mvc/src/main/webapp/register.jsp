...
<!-- 
		...
		required, maxlenght, max, min, email, url
	 -->
...
<form action='<c:url value="/register.do" />' method="post" novalidate>
	...
	<div class="mb-3">
		...
		<input type="radio" name="gender" id="" value="남" class="form-check-input" required />
		남
		<input type="radio" name="gender" id="" value="여" class="form-check-input" required />
		여
...
<script src='<c:url value="/js/register.js"/>'>
